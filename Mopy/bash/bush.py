...
"""This module defines static data for use by other modules in the Wrye Flash package.
...
conditionFunctionData = (  # --0: no param; 1: int param; 2: formid param
    ...
    (6, 'GetPos', 0, 0, 0, 0),
    (8, 'GetAngle', 0, 0, 0, 0),
    (10, 'GetStartingPos', 0, 0, 0, 0),
    (11, 'GetStartingAngle', 0, 0, 0, 0),
    (12, 'GetSecondsPassed', 0, 0, 0, 0),
    (14, 'GetActorValue', 2, 0, 0, 0),
    ...
    (464, 'IsPlayerGrabbedRef', 2, 0, 0, 0),
    ...
    (492, 'GetMapMarkerVisible', 0, 0, 0, 0),
    (495, 'GetPermanentActorValue', 2, 0, 0, 0),
    ...
    (518, 'GetVATSRightAreaFree', 2, 0, 0, 0),
    (519, 'GetVATSLeftAreaFree', 2, 0, 0, 0),
    (520, 'GetVATSBackAreaFree', 2, 0, 0, 0),
    (521, 'GetVATSFrontAreaFree', 2, 0, 0, 0),
    (522, 'GetIsLockBroken', 0, 0, 0, 0),
    (523, 'IsPS3', 0, 0, 0, 0),
    (524, 'IsWin32', 0, 0, 0, 0),
    (525, 'GetVATSRightTargetVisible', 2, 0, 0, 0),
    (526, 'GetVATSLeftTargetVisible', 2, 0, 0, 0),
    (527, 'GetVATSBackTargetVisible', 2, 0, 0, 0),
    (528, 'GetVATSFrontTargetVisible', 2, 0, 0, 0),
    ...
    (1165, 'GetWeaponHasScope', 2, 0, 0, 0),
...
hostileEffects |= set(
    (ctypes.cast(x, ctypes.POINTER(ctypes.c_ulong)).contents.value for x in
        hostileEffects))
