...
class CreateNewProject(wx.Dialog):
    def __init__(self, parent, id, title):
        ...
        self.statictext1 = wx.StaticText(self.panel, wx.ID_ANY, u'What do you what to name the New Project?', (-1, -1), style=wx.TE_RICH2)
        self.textctrl = wx.TextCtrl(self.panel, wx.ID_ANY, u'New Project Name-#####',(-1,-1))
        self.statictext2 = wx.StaticText(self.panel, wx.ID_ANY, u'What do you what to add to the New Project?', (-1, -1))
        self.checkboxblankesp = wx.CheckBox(self.panel, wx.ID_ANY, u'Blank.esp', (-1, -1))
        self.checkboxblankesp.SetValue(True)
        self.checkboxblankwizard = wx.CheckBox(self.panel, wx.ID_ANY, u'Blank wizard.txt', (-1, -1))
        self.checkboxwizardimagesdirectory = wx.CheckBox(self.panel, wx.ID_ANY, u'Wizard Images Directory', (-1, -1))
        ...
        self.checkboxdocsdirectory = wx.CheckBox(self.panel, wx.ID_ANY, u'Docs Directory', (-1, -1))
        self.checkboxscreenshotnoext = wx.CheckBox(self.panel, wx.ID_ANY, u'Preview Screenshot(No.ext)(re-enable for BAIT)', (-1, -1))
